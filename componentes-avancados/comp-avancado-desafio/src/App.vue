<template>
	<div id="app">
		<span>
			<button class="vermelho" @click="changeComponent('Vermelho')">Carregar Componente Vermelho</button>
			<button class="verde" @click="changeComponent('Verde')">Carregar Componente Verde</button>
			<button class="azul" @click="changeComponent('Azul')">Carregar Componente Azul</button>
		</span>
